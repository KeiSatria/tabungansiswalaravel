...
@endif
            ...
            <main class="flex-1">
                <header class="flex items-center justify-between p-4">
                    <div class="flex items-center space-x-4 md:space-x-0">
                        ...
                        <h1 class="text-2xl font-medium">Admin Dashboard</h1>
                    </div>
    ...
    <a href="/register" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style="padding: 10px 20px; margin-right: 10px;">
        Tambah Data
    </a>
</div>
        <body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-1x1  sm-4">Catatan : Untuk Akun Yang Ingin Diganti Datanya Harus Dihapus Dulu Lalu Buat Akun Baru </h1>
        <h1 class="text-1x1  mb-4">Dikarenakan Website Masih Dalam Pengembangan</h1>
        <h1 class="text-2xl font-bold mb-4">Daftar Pengguna</h1>
        <div class="overflow-x-auto">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border">
    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
            <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border">Nama</th>
            <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border">Email</th>
            <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border">Password</th>
            <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border">Role</th>
            <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border">Aksi</th>
        </tr>
    </thead>
    <tbody class="text-gray-600">
        @foreach($users as $user)
        <tr class="table-dark border">
            <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800 border">{{ $user->name }}</td>
            <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800 border">{{ $user->email }}</td>
            <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800 border">{{ $user->password }}</td>
            <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800 border">{{ $user->role }}</td>
            <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800 border">
                <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="return confirmAndNotify(event, 'Apakah Anda Ingin Menghapus Data Ini?');">Hapus</button>
                </form>
            </td>
        </tr>
        @endforeach
