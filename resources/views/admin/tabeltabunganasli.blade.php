    ...
    <main class="flex-1">
        <header class="flex items-center justify-between p-4">
            <div class="flex items-center space-x-4 md:space-x-0">
                ...
                <h1 class="text-2xl font-medium">Data Lengkap</h1>
            </div>
            <div class="space-x-2">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <a href="/siswa/tambah" class="btn btn-primary active" aria-current="page"> </a>
...
<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border">
    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
                        ...
                        <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800">Nomor Tabungan</th>
                        <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800">Nama</th>
                        <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800">Tanggal Lahir</th>
                        <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800">Saldo</th>
                        <th scope="col" class="px-6 py-4 bg-gray-50 dark:bg-gray-800">Nomor Telepon</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($data_lengkap as $p)
                    <tr class="border-b">
