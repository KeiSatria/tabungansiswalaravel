...
>
    ...
    <div
        ...
        class="fixed inset-0 z-10 bg-emerald-800 md:hidden"
        style="opacity: 0.5"
        aria-hidden="true"
    ></div>
...
@endif
    ...
    <div class="flex flex-1 h-screen overflow-y-scroll">
        ...
        <header class="flex items-center justify-between p-4">
            ...
            <h1 class="text-2xl font-medium">Data Tabungan</h1>
            </div>
            <div class="space-x-2">
    ...
    <a href="/admin/tabungan/tambah" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style="padding: 10px 20px; margin-right: 10px;">
        Tambah Data
    </a>
</div> 
<br> 
...
<body>
<div class="mb-4">
    <form action="{{ route('admin/tabungan/cari') }}" method="GET" class="flex items-center">
        <input type="text" name="cari" placeholder="Cari tabungan berdasarkan nama..." class="border border-gray-300 p-2 rounded-md w-full mr-2">
        <button type="submit" name="submit" value="search" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center w-32">
            Cari
        </button>
    </form>
</div>
...
<table class="w-full text-md text-left rtl:text-right text-gray-500 dark:text-gray-400 border">
    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr class="table-dark">
        <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                 Nomor Tabungan</td>
                 <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                 Nama</td>
                 <td class="text-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
    ...
    <tbody>
        ...
        <a href="/admin/tabungan/edit/{{ $p->nomor_tabungan }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Data Tabungan
        </a>
        <a href="{{ route('tabungan.detail-transaksi', $p->nomor_tabungan) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Transaksi Terakhir</a>
                
        
                    <a href="{{ route('formTransaksi', $p->nomor_tabungan) }}"class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Transaksi</a>
    ...
    window.onload = function() {
        ...
        if (notificationMessage) {
            ...
            localStorage.removeItem("notificationMessage");
                ...
                <a href="/admin/tabungan/hapus/{{ $p->nomor_tabungan }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="return confirmAndNotify(event, 'Apakah Anda Ingin Menghapus Data Ini?');">
    Hapus
</a>
