...
@endif
        ...
        <h2 class="text-2xl font-bold text-gray-800 dark:text-light">Jadilah admin yang profesional ya</h2>
    </div>

    <!-- Gambar -->
    <div class="p-4">
        <img src="/images/adminprofesional.jpg" alt="Gambar" class="w-full max-w-6xl mx-auto" style="max-width: 800px;">
    </div>
<br><br>
